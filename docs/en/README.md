...
* Handy [NPM scripts](https://soixantecircuits.github.io/electron-vue/en/npm_scripts.html)
...
* [Service
  worker](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API) to cache assets when offline\*
...
Make sure to check out [**A Note for Windows Users**](https://soixantecircuits.github.io/electron-vue/en/getting_started.html#a-note-for-windows-users) to make sure you have all the necessary build tools needed for electron and other dependencies.
...
```bash
vue init soixantecircuits/electron-vue#1.0 my-project
```

### Next Steps

Make sure to take a look at the [documentation](https://soixantecircuits.github.io/electron-vue/). Here you will find useful information about configuration, project structure, and building your app. There's also a handy [FAQs](https://soixantecircuits.github.io/electron-vue/en/faqs.html) section.

## Developement

### Testing

The template is automatically tested on [Semaphore
CI](https://semaphoreci.com/emmanuelgeoffray/electron-vue).  
